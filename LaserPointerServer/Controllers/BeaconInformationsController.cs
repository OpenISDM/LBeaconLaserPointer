...
namespace LBeacon.Controllers
{
    ...
    public class BeaconInformationsController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "Id,Name,Latitude,Longitude,Floor")] BeaconInformation beaconInformation)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "Id,Name,Latitude,Longitude,Floor")] BeaconInformation beaconInformation)
        {
            if (ModelState.IsValid)
            {
